...
public class uGUITools : MonoBehaviour {
	[MenuItem("Window/uGUI/Anchors to Corners %[")]
	...
	[MenuItem("Window/uGUI/Corners to Anchors %]")]
	...
	[MenuItem("Window/uGUI/Mirror Horizontally Around Anchors %;")]
	static void MirrorHorizontallyAnchors(){
		MirrorHorizontally(false);
	}

	[MenuItem("Window/uGUI/Mirror Horizontally Around Parent Center %:")]
	...
	[MenuItem("Window/uGUI/Mirror Vertically Around Anchors %'")]
	static void MirrorVerticallyAnchors(){
		MirrorVertically(false);
	}
	
	[MenuItem("Window/uGUI/Mirror Vertically Around Parent Center %\"")]
